...
public class DemoSecurityConfig {
    ...
    public InMemoryUserDetailsManager userDetailsManager() {
        ...
        UserDetails mary = User.builder().username("mary").password("{noop}12123").roles("EMPLOYEE").build();

        UserDetails susan = User.builder().username("susan").password("{noop}12123").roles("MANAGER", "ADMIN").build();
